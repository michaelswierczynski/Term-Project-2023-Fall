...
# target_bookmaker = 'bovada'

# # Iterate through games and print information for the specified bookmaker
# for game_id, game_data in bookmakers_data.items():
#     if target_bookmaker in game_data['bookmakers']:
#         print(f'\nGame ID: {game_id}')
#         print('Bookmakers:')
#         for bookmaker_key, bookmaker_info in game_data['bookmakers'].items():
#             if bookmaker_key == target_bookmaker:
#                 print(f'  {bookmaker_info} (Key: {bookmaker_key})')
#                 print(f'    Favored Spread: {game_data["spreads_favored"][bookmaker_key]}')
#                 print(f'    Underdog Spread: {game_data["spreads_underdog"][bookmaker_key]}')
#                 print(f'    Adjusted Favored Spread: {game_data["adjusted_spreads_favored"][bookmaker_key]}')
#                 print(f'    Adjusted Underdog Spread: {game_data["adjusted_spreads_underdog"][bookmaker_key]}')